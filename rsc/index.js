webpackJsonp([0], [function(t, i, n) {
    function e() {
        o(document).on("click", "[xl-xla-type]", function() {
            var t = o(this),
                i = t.attr("xl-xla-category"),
                n = t.attr("xl-xla-action"),
                e = t.attr("xl-xla-extdata");
            window.xla.push({
                type: "event",
                category: i,
                action: n,
    ...
    function a() {
        ...
        t.on("mouseleave", function() {
            ...
            for (var t = i.index(o(this)), e = i.eq(t).width(), a = 0, s = 0; s < t; s++) a += i.eq(s).outerWidth() + 20;
            a += 16, n.show(), n.css({
                left: a,
                width: e
            })
        ...
        var e, a = o("#wrap"),
            s = function() {
                ...
                for (var i in t)
                    if (i.toLowerCase().indexOf("animation") >= 0) return !0;
                return !1
            }(),
            h = o("#page_wp").find(".page"),
            r = o("#star_wp"),
            c = o("#btn_control").find("a"),
            p = [5e3, 5e3, 5e3, 1e4];
        if (s) a.addClass("css3");
        else {
            for (var d = h.find(".img_box"), f = 1; f < 5; f++) d.eq(f - 1).find("img")[0].src = "img/0" + f + ".jpg";
            window.onresize = function() {
                var t = o(window).width(),
                    i = o(window).height();
                t / i < 1920 / 1080 ? d.height(i).css({
                    width: "auto",
                    margin: -.5 * i + "px 0 0 " + -960 / 1080 * i + "px"
                }) : d.width(t).css({
                    height: "auto",
        ...
        var l = {
                one: function() {
                    h.removeClass("show").eq(0).addClass("show"), s ? (r.removeClass("show"), cvsEffect.one()) : h.stop().eq(0).css({
                        opacity: 0
                    }).animate({
                        opacity: 1
                    }, 500)
                ...
                two: function() {
                    s ? (h.eq(0).hasClass("show") && h.eq(0).addClass("hide"), r.removeClass("show"), cvsEffect.two(), setTimeout(function() {
                        ...
                        opacity: 1
                    }, 500), h.removeClass("show").eq(1).addClass("show")
                },
                three: function() {
                    h.removeClass("show").eq(2).addClass("show"), s ? (cvsEffect.three(), r.addClass("show")) : h.stop().eq(2).css({
                        opacity: 0
                    }).animate({
                        opacity: 1
                    }, 500)
                ...
                four: function() {
                    h.removeClass("show").eq(3).addClass("show"), s ? (cvsEffect.four(), r.addClass("show")) : h.stop().eq(3).css({
                        opacity: 0
                    }).animate({
                        opacity: 1
                    }, 500)
    ...
    function s() {
        ...
        function i(t, i) {
            ...
            return o.ajax({
                ...
                return localStorage.setItem(t, JSON.stringify(i)), i
            }, function() {
    ...
    ! function() {
        function t(i, n) {
            this.point = {
                x: 0,
                y: 0
            }, this.point.x = i.x, this.point.y = i.y, this.len = n || 1, this.lWidth = 1, this.speed = u.iSpeed, this.opc = .5, this.isEnd = !1, "function" != typeof this.nextFps && (t.prototype.nextFps = function() {
        ...
        function i(t) {
            this.point = t || {
                x: 0,
                y: 0
            }, this.rad = Math.random(), Math.random() > .9 && (this.rad = 2), this.speed = 1 * Math.random() + .1, this.opc = Math.random() / 2 + .3, this.R = Math.sqrt(this.point.x * this.point.x + this.point.y * this.point.y), "function" != typeof this.nextFps && (i.prototype.nextFps = function() {
                if (1 == w.way) {
        ...
        function e() {
            this.step = .05, this.isEnd = !1, this.opc = 1, "function" != typeof this.nextFps && (e.prototype.nextFps = function() {
        ...
        if (a) {
            ...
            var d, f = {
                    ...
                    createPoints: function(t, i, n, e, a) {
                        for (var s = [], o = 0; o < a; o++) s.push({
                            x: t + Math.random() * (n - t),
                            y: i + Math.random() * (e - i)
                        });
                        return s
                ...
                u = {
                    ...
                    iSpeed: 1.5,
                    dSpeed: .8,
                    newPoint: function(t, i) {
                        var n = t.x * t.x + t.y * t.y + i * i + 2 * i * Math.sqrt(t.x * t.x + t.y * t.y);
                        return {
                    ...
                    createRay: function(i) {
                        for (var n, e = {
                                x: 0,
                                y: 0
                            }, a = 15, s = 0; s < i; s++) e.x = Math.random() * a * f.createSign(), e.y = Math.sqrt(a * a - e.x * e.x) * f.createSign(), n = Math.ceil(3 * Math.random()), l.push(new t(e, n))
                    }
                },
                y = [],
                x = [],
                w = {
                    ...
                    createParticle: function() {
                        for (var t = [], n = 0; n < 10; n++)
                            for (var e = 0; e < 5; e++) {
                                t = f.createPoints(-.5 * h + .1 * n * h, -.5 * r + .2 * e * r, -.5 * h + .1 * (n + 1) * h, -.5 * r + .2 * (e + 1) * r, 6);
                                for (var a = 0; a < t.length; a++) 0 != t[a].x && 0 != t[a].y && y.push(new i(t[a]))
                            }
                    },
                    createParticle2: function() {
                        for (var t = [], i = 0; i < 5; i++)
                            for (var e = 0; e < 2; e++) {
                                t = f.createPoints(-.5 * h + .2 * i * h, -.5 * r + .5 * e * r, -.5 * h + .2 * (i + 1) * h, -.5 * r + .5 * (e + 1) * r, 1);
                                for (var a = 0; a < t.length; a++) 0 != t[a].x && 0 != t[a].y && x.push(new n(t[a]))
                            }
                    }
                },
                v = new e,
                g = {
                    drawParticle: function() {
                        for (var t = 0; t < y.length; t++) y[t].nextFps(), y[t].draw(p)
                    },
                    drawParticle2: function() {
                        for (var t = 0; t < x.length; t++) x[t].nextFps(), x[t].isEnd ? (x.splice(t, 1), t--) : x[t].draw(p)
                    },
                    drawRay: function() {
                        for (var t = 0; t < l.length; t++) l[t].nextFps(), l[t].isEnd ? (l.splice(t, 1), t--) : l[t].draw(p)
                    }
                },
                m = function() {
            ...
            window.onresize = function() {
                h = document.body.offsetWidth, r = document.body.offsetHeight, s.setAttribute("width", h), s.setAttribute("height", r), c.width = h, c.height = r, y = [], w.createParticle()
            }, window.cvsEffect = function(t, i) {}, cvsEffect.start = function() {
                requestAnimFrame(m)
            }, cvsEffect.one = function() {
                d = 1, w.way = 0, y = [], w.createParticle()
            }, cvsEffect.two = function() {
                d = 2, w.way = 1, y = [], w.createParticle(), x = [], w.createParticle2(), v.isEnd = !0, setTimeout(function() {
                    v.step = .05, v.opc = 1, v.isEnd = !1
                }, 50)
            }, cvsEffect.three = function() {
                d = 3, 0 == y.length && w.createParticle(), w.way = 1
            }, cvsEffect.four = function() {
                0 == y.length && w.createParticle(), w.way = 1, d = 4
            }
        }
    }()
}]);